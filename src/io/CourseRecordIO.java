    	...
    	try {
          //read in tokens for name, title, section, credits, instructorId, and meetingDays and store in local variables
    		...
    		if("A".equals(meetingDays)) {
    			if(scan.hasNext()) {
    				scan.close();
    				throw new IllegalArgumentException("has next (placeholder)");
    			} else {
    				scan.close();
    			...
    			if(scan.hasNext()) {
    				scan.close();
    				throw new IllegalArgumentException("hasNext (placeholder)");
    			}
    			scan.close();
    	   ...
    	   throw new IllegalArgumentException("try catch (placeholder)");
       }
